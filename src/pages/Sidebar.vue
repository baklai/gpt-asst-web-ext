    ...
    <div class="flex flex-col justify-center w-full p-8 pt-0 lg:w-1/2 lg:px-12 xl:px-24">
      <div class="-mx-2 md:items-center md:flex">
        <div class="flex-1 px-2 mt-4 md:mt-0">
          <label for="apikey" class="block mb-2 text-sm text-gray-600 dark:text-gray-200"
            >OpenAI API</label
          >
          <input
            id="apikey"
      ...
      <div class="w-full mt-4">
        <label for="yourself" class="block mb-2 text-sm text-gray-600 dark:text-gray-200"
